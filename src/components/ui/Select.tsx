          ...
          <SelectPrimitive.Viewport className="p-1">
            {options.map((opt) => (
              <SelectPrimitive.Item
                key={opt}
                value={opt}
                className="relative flex items-center px-3 py-2 rounded-md text-gray-700 dark:text-white text-sm cursor-pointer hover:bg-slate-400 focus:bg-slate-400 focus:outline-none"
              >
