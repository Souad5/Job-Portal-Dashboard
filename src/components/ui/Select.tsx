...
export default function Select({ name, label, options }: SelectProps) {
  ...
  return (
    <div className="space-y-1 w-full sm:w-1/3">
      ...
      >
        <SelectPrimitive.Trigger className="w-full flex justify-between items-center px-3 py-2 border border-gray-200 rounded-md text-md focus:outline-none focus:ring-2 focus:ring-blue-200 bg-white">
